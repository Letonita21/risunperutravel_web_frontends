...
const page = async ({ params }) => {
  ...
  const dict = diccionario.PoliticaDeCalidad;
            ...
            <span className="relative inline-block">
              ...
              <span
                className="absolute left-0 bottom-0 h-1 w-4/5
                        bg-linear-to-r from-cyan-900 via-cyan-400 to-cyan-50
                        rounded-full"/>
            </span>
          </h1>
        </div>
      ...
      <div className="w-full mt-5">
        <div className="w-11/12 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 min-h-screen">
          <div className="md:col-span-2 flex flex-col mb-8">
            <h1 className="text-xl md:text-4xl font-bold mb-4">{dict.nombre}</h1>
            <div
