...
const TripAdvisorCarrusel = ({ dict }) => {
          ...
          >
            ...
            <div className="flex gap-5">
              {[...testimonials, ...testimonials].map((item, index) => (
                <div
                  key={index}
                  className="block w-80 md:w-96 bg-white rounded-lg p-4 border-4 h-60 border-green-400 drop-shadow-xl drop-shadow-gray-300"
                >
                  ...
                  <div className="flex space-x-1  my-2 text-green-500">
...
export default TripAdvisorCarrusel;
